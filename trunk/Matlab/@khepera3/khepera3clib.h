...
extern "C" {
	...
	__declspec(dllexport) int FollowLine(int robotID, bool on, double aggressivity, int speed);
	__declspec(dllexport) int Cross(int robotID, int direction, double aggressivity, int speed);
