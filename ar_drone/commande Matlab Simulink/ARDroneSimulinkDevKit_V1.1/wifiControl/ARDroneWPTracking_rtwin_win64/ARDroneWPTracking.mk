...
MODEL                := ARDroneWPTracking
MODULES              := ARDroneWPTracking_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := ARDroneWPTracking.mk
...
#
MODELLIB                  := ARDroneWPTrackinglib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := ARDroneWPTracking_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES := $(REQ_INCLUDES);C:/ENSEM-~1/ar_drone/COMMAN~3/ARDRON~1.1/WIFICO~1/ARDroneWPTracking_rtwin_win64;C:/ENSEM-~1/ar_drone/COMMAN~3/ARDRON~1.1/WIFICO~1
