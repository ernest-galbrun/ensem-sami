#include "ARDroneWPTracking_sfun.h"
#include "sfcdebug.h"
...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_ARDroneWPTracking_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_ARBlocks_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_ARDroneWPTracking_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  if (sf_ARBlocks_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_ARDroneWPTracking_process_testpoint_info_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_ARBlocks_process_testpoint_info_call( int nlhs, mxArray
    * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_ARDroneWPTracking_process_testpoint_info_call(nlhs,plhs,nrhs,prhs))
    return 1;
  if (sf_ARBlocks_process_testpoint_info_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
unsigned int sf_process_autoinheritance_call( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_ARDroneWPTracking_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_ARBlocks_autoinheritance_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "ARDroneWPTracking") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ARDroneWPTracking_autoinheritance_info(nlhs,plhs,3,newRhs);
  }

  if (strcmp(machineName, "ARBlocks") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ARBlocks_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_third_party_uses_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_ARDroneWPTracking_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_ARBlocks_third_party_uses_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "ARDroneWPTracking") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ARDroneWPTracking_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
  ...
  if (strcmp(machineName, "ARBlocks") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ARBlocks_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_ARDroneWPTracking_get_eml_resolved_functions_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_ARBlocks_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  if (strcmp(machineName, "ARDroneWPTracking") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_ARDroneWPTracking_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
  ...
  if (strcmp(machineName, "ARBlocks") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_ARBlocks_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_ARDroneWPTracking_method_dispatcher(SimStruct *S,
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data);
extern unsigned int sf_ARBlocks_method_dispatcher(SimStruct *S, unsigned int
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"ARDroneWPTracking")) {
    return(sf_ARDroneWPTracking_method_dispatcher(simstructPtr,chartFileNumber,
            specsCksum,method,data));
  }

  if (!strcmp(machineName,"ARBlocks")) {
    return(sf_ARBlocks_method_dispatcher(simstructPtr,chartFileNumber,specsCksum,
            method,data));
  }
...
extern void ARDroneWPTracking_terminator(void);
extern void ARBlocks_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    ARDroneWPTracking_terminator();
    ARBlocks_terminator();
...
extern void ARDroneWPTracking_initializer(void);
extern void ARBlocks_initializer(void);
extern void ARDroneWPTracking_register_exported_symbols(SimStruct* S);
extern void ARBlocks_register_exported_symbols(SimStruct* S);
extern void ARDroneWPTracking_debug_initialize(struct SfDebugInstanceStruct*);
extern void ARBlocks_debug_initialize(struct SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  ARDroneWPTracking_register_exported_symbols(S);
  ARBlocks_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      ARDroneWPTracking_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    ARDroneWPTracking_initializer();
    if (!simModeIsRTWGen) {
      ARBlocks_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    ARBlocks_initializer();
  }
