  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"ARBlocks")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(544810047U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3457660948U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3213667214U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3355470474U);
        } else if (nrhs==4) {
          unsigned int chartFileNumber;
