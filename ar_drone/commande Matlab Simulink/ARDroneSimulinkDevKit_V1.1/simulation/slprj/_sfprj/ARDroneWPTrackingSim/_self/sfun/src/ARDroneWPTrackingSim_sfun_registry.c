#include "ARDroneWPTrackingSim_sfun.h"
#include "sfcdebug.h"
...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_ARDroneWPTrackingSim_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_ARBlocks_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_ARDroneWPTrackingSim_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
...
{
  extern unsigned int sf_ARDroneWPTrackingSim_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "ARDroneWPTrackingSim") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ARDroneWPTrackingSim_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_third_party_uses_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_ARDroneWPTrackingSim_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "ARDroneWPTrackingSim") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ARDroneWPTrackingSim_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_ARDroneWPTrackingSim_get_eml_resolved_functions_info
  ...
  if (strcmp(machineName, "ARDroneWPTrackingSim") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_ARDroneWPTrackingSim_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_ARDroneWPTrackingSim_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"ARDroneWPTrackingSim")) {
    return(sf_ARDroneWPTrackingSim_method_dispatcher(simstructPtr,
...
extern void ARDroneWPTrackingSim_terminator(void);
...
void sf_machine_global_terminator(void)
{
  ...
  if (sfGlobalMdlStartCallCounts == 0) {
    ARDroneWPTrackingSim_terminator();
    ARBlocks_terminator();
...
extern void ARDroneWPTrackingSim_initializer(void);
extern void ARBlocks_initializer(void);
extern void ARDroneWPTrackingSim_register_exported_symbols(SimStruct* S);
extern void ARBlocks_register_exported_symbols(SimStruct* S);
extern void ARDroneWPTrackingSim_debug_initialize(struct SfDebugInstanceStruct*);
extern void ARBlocks_debug_initialize(struct SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  ARDroneWPTrackingSim_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      ARDroneWPTrackingSim_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    ARDroneWPTrackingSim_initializer();
    if (!simModeIsRTWGen) {
