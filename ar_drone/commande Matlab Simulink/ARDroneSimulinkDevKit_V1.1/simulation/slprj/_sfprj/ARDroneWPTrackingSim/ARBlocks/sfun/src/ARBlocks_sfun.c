  ...
  chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  if (chartFileNumber==5) {
    c5_ARBlocks_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"ARBlocks")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(141670390U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(365903845U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(117534108U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3142900856U);
        } else if (nrhs==4) {
          ...
          switch (chartFileNumber) {
           case 5:
            {
              extern void sf_c5_ARBlocks_get_check_sum(mxArray *plhs[]);
              sf_c5_ARBlocks_get_check_sum(plhs);
              break;
            }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 5:
      {
        if (strcmp(aiChksum, "uRxJ0qCrMDvbFjNoQP8wMH") == 0) {
          extern mxArray *sf_c5_ARBlocks_get_autoinheritance_info(void);
          plhs[0] = sf_c5_ARBlocks_get_autoinheritance_info();
          break;
        }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 5:
      {
        extern const mxArray *sf_c5_ARBlocks_get_eml_resolved_functions_info
          (void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c5_ARBlocks_get_eml_resolved_functions_info();
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 5:
      {
        if (strcmp(tpChksum, "bAESyz017T0ICfxD2mpHPH") == 0) {
          extern mxArray *sf_c5_ARBlocks_third_party_uses_info(void);
          plhs[0] = sf_c5_ARBlocks_third_party_uses_info();
          break;
        }
      }
